...
function setFeishuDmPolicy(cfg: NEMOConfig, dmPolicy: DmPolicy): NEMOConfig {
  const allowFrom =
    dmPolicy === "open"
...
function setFeishuAllowFrom(cfg: NEMOConfig, allowFrom: string[]): NEMOConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
...
function setFeishuGroupAllowFrom(cfg: NEMOConfig, groupAllowFrom: string[]): NEMOConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
